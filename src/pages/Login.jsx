    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-gray-900">Sign in to Ad Analytics</h1>
          <p className="mt-2 text-sm text-gray-500">Monitor all your ad campaigns in one place</p>
        </div>
